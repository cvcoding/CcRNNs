            ...
            for layer_idx in range(self.num_layers):
                ...
                if (pointer >= 0.99) or t == seq_len - 1:
                    ...
                    if layer_idx == self.num_layers - 1:  # ding ceng
                        ...
                        repeat_c = c[layer_idx].repeat(1, tcn_current_output.shape[1]).reshape(
                        ...
                        att = torch.tanh(
                            F.linear(repeat_c, self.W_a) + F.linear(tcn_current_output, self.U_a) + F.linear(
                                repeat_cur_x,
