        ...
        if counter <= 17:
            ...
            for j in range(len(rpeak)):
                if rpeak_resample[j] <= seqlen / 2:
                    data_train[j, : int(rpeak_resample[j]) + int(seqlen / 2)] = rdata_resample[
                ...
                if rpeak_resample[j] + int(seqlen / 2) > len(rdata_resample):
                    data_train[j, : len(rdata_resample) - int(rpeak_resample[j]) + int(seqlen / 2)] = rdata_resample[
                                                                                                      int(
                                                                                                          rpeak_resample[
                                                                                                              j]) - int(
                                                                                                          seqlen / 2):]
