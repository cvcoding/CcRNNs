...
parser.add_argument('--nlstmhid', type=int, default=2,
                    help='number of hidden units per layer (default: 25)')
parser.add_argument('--nhid', type=int, default=128,
                    help='number of hidden units per layer (default: 25)')
parser.add_argument('--seed', type=int, default=1111,
                    help='random seed (default: 1111)')
parser.add_argument('--permute', action='store_true', default=True,
...
permute = torch.Tensor(np.random.permutation(1024*3).astype(np.float64)).long()
